...
from .views import HorarioByID, HorarioAll, HorarioMixed, HorarioByPlan, HorarioschoqueDocente, HorariobyComponente

app_name = "horario"
urlpatterns = [
    path('', HorarioAll.as_view()),
    path('horadia', HorarioschoqueDocente.as_view()),
